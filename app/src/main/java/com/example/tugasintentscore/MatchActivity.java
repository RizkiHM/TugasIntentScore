...
public class MatchActivity extends AppCompatActivity {
    ...
    private Button addHome1,addHome2,addHome3,addHome4;
    private Button addAway1,addAway2,addAway3,addAway4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addHome4 = findViewById(R.id.btn_add_home_4);
        ...
        addAway4 = findViewById(R.id.btn_add_away_4);
        ...
        addHome4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                homescore = 0;
                scoreHome.setText(String.valueOf(homescore));
        ...
        addAway4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                awayscore = 0;
                scoreAway.setText(String.valueOf(awayscore));
